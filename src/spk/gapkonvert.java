 ...
 */
public class gapkonvert extends javax.swing.JFrame {
...
private Connection conn = new koneksi().connect();
 ...
 protected void aktif() {
    ...
    private void dataGap() {
        ...
        private void dataNormal() {
        Object[] Baris ={"Id Gap", "nilaiAwal","id Guru", "Nama Guru", "Disiplin", "Komitmen", "Loyal", "Prestasi"};
        tabmode = new DefaultTableModel(null, Baris);
        jTable12.setModel(tabmode);
        String sql = "select * from normaltable";
        try {
        java.sql.Statement stat = conn.createStatement();
        ResultSet hasil = stat.executeQuery(sql);
        ...
        while (hasil.next()) {
            ...
            String[] data = {idGap, nilaiAwal, idGuru, namaGuru, disiplin, komitmen, loyal, prestasi};
            tabmode.addRow(data);
        }
    } catch (SQLException e) {
        JOptionPane.showMessageDialog(null, "Error: " + e.getMessage());
    ...
    private void initComponents() {
        ...
        tablegap = new javax.swing.JButton();
        delete = new javax.swing.JButton();
        tablekonvert = new javax.swing.JButton();
        ...
        jPanel1.add(gapteks, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, 140, -1));

        idGap.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(idGap, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 310, 90, -1));

        awalTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        awalTeks.setText("Id Nilai Awal");
        jPanel1.add(awalTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 350, 140, -1));

        guruTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        guruTeks.setText("Id Guru");
        jPanel1.add(guruTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 390, 140, -1));

        idGuru.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(idGuru, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 390, 90, -1));

        namaGuru.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(namaGuru, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 430, 90, -1));

        nama1.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        nama1.setText("Nama Guru");
        jPanel1.add(nama1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 430, 140, -1));

        DisiplinTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        DisiplinTeks.setText("Nilai Disiplin");
        jPanel1.add(DisiplinTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 470, 140, -1));

        disiplin.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(disiplin, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 470, 90, -1));

        komitmenTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        komitmenTeks.setText("Nilai Komitmen");
        jPanel1.add(komitmenTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 510, 140, -1));

        komitmen.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(komitmen, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 510, 90, 30));

        loyalTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        loyalTeks.setText("Nilai Loyal");
        jPanel1.add(loyalTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 550, 140, 40));

        loyal.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(loyal, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 550, 90, -1));

        prestasiTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        prestasiTeks.setText("Nilai Prestasi");
        jPanel1.add(prestasiTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 590, 140, 40));

        prestasi.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(prestasi, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 590, 90, -1));

        nilaiAwal.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(nilaiAwal, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 350, 90, -1));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 650, 80, 40));
        ...
        jPanel1.add(save1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 650, 80, 40));

        tablegap.setText("Muat Tabel Sebelum Konversi");
        tablegap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tablegapActionPerformed(evt);
            }
        });
        jPanel1.add(tablegap, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 650, 200, 40));
        ...
        jPanel1.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 650, 80, 40));

        tablekonvert.setText("Muat Tabel Konversi");
        tablekonvert.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tablekonvertActionPerformed(evt);
            }
        });
        jPanel1.add(tablekonvert, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 650, 140, 40));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 310, 670, 310));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bg/spk convert.png"))); // NOI18N
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        String checkSql = "SELECT COUNT(*) FROM normaltable WHERE idGap = ?";
    String insertSql = "INSERT INTO normaltable (idGap, nilaiAwal, idGuru, namaGuru, nilaiDisiplin, nilaiKomitmen, nilaiLoyal, nilaiPrestasi) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    
    try {
        String idGapText = idGap.getText();
        String nilaiAwalText = nilaiAwal.getText();
        String idGuruText = idGuru.getText();
        String namaGuruText = namaGuru.getText();
        String disiplinValue = disiplin.getText();
        String komitmenValue = komitmen.getText();
        String loyalValue = loyal.getText();
        String prestasiValue = prestasi.getText();
        
        // Cek apakah idGap sudah ada di tabel
        PreparedStatement checkStmt = conn.prepareStatement(checkSql);
        checkStmt.setString(1, idGapText);
        ...
        if (rs.next()) {
            ...
            if (count > 0) {
                ...
                JOptionPane.showMessageDialog(null, "ID sudah ada. Silakan gunakan ID yang berbeda.");
                return;
            }
        }
        ...
        insertStmt.setString(1, idGapText);
        insertStmt.setString(2, nilaiAwalText);
        insertStmt.setString(3, idGuruText);
        insertStmt.setString(4, namaGuruText);
        insertStmt.setString(5, disiplinValue);
        insertStmt.setString(6, komitmenValue);
        insertStmt.setString(7, loyalValue);
        insertStmt.setString(8, prestasiValue);
    ...
    private void tablegapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tablegapActionPerformed
        dataGap();
    }//GEN-LAST:event_tablegapActionPerformed

    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        // TODO add your handling code here:
        int ok=JOptionPane.showConfirmDialog(null, "Hapus", "Konfirmasi Dialog", JOptionPane.YES_NO_CANCEL_OPTION);
        if (ok==0){
            String sql= "delete from normaltable where idGap = '"+idGap.getText()+"'";
            try{
    ...
    if (row != -1) { // Pastikan baris yang dipilih valid
        ...
        String idGapValue = tabmode.getValueAt(row, 0).toString();
        String nilaiAwalValue = tabmode.getValueAt(row, 1).toString();
        String idGuruValue = tabmode.getValueAt(row, 2).toString();
        String namaGuruValue = tabmode.getValueAt(row, 3).toString();
        String disiplinValue = tabmode.getValueAt(row, 4).toString();
        String komitmenValue = tabmode.getValueAt(row, 5).toString();
        String loyalValue = tabmode.getValueAt(row, 6).toString();
        String prestasiValue = tabmode.getValueAt(row, 7).toString();

        
        // Mengonversi nilai ke format yang diinginkan
        String convertedDisiplin = convertValueToDisplay(disiplinValue);
        String convertedKomitmen = convertValueToDisplay(komitmenValue);
        String convertedLoyal = convertValueToDisplay(loyalValue);
        String convertedPrestasi = convertValueToDisplay(prestasiValue);


        // Menampilkan data pada komponen
        idGap.setText(idGapValue);
        nilaiAwal.setText(nilaiAwalValue);
        idGuru.setText(idGuruValue);
        namaGuru.setText(namaGuruValue);
        disiplin.setText(convertedDisiplin);
        komitmen.setText(convertedKomitmen);
        loyal.setText(convertedLoyal);
        prestasi.setText(convertedPrestasi);
           }
}

// Fungsi konversi nilai dari format tabel ke format tampilan
private String convertValueToDisplay(String value) {
    try {
        ...
        switch (intValue) {
            ...
            case 11: return "11";
            case 12: return "12";
            default: return "0"; // nilai default jika tidak ada yang cocok
        }
    } catch (NumberFormatException e) {
    ...
    private void tablekonvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tablekonvertActionPerformed
        // TODO add your handling code here:
         dataNormal();
    }//GEN-LAST:event_tablekonvertActionPerformed
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        // TODO add your handling code here:
        String selectSql = "SELECT COUNT(*) FROM normaltable WHERE idGap = ?";
    String updateSql = "UPDATE normaltable SET nilaiAwal=?, idGuru=?, namaGuru=?, nilaiDisiplin=?, nilaiKomitmen=?, nilaiLoyal=?, nilaiPrestasi=? WHERE idGap=?";
    ...
    try {
        ...
        selectStmt.setString(1, idGapText);
        ...
        // Jika ID tidak ada, lakukan update
        PreparedStatement updateStmt = conn.prepareStatement(updateSql);
        updateStmt.setString(1, nilaiAwalText);
        updateStmt.setString(2, idGuruText);
        updateStmt.setString(3, namaGuruText);
        updateStmt.setString(4, disiplinValue);
        updateStmt.setString(5, komitmenValue);
        updateStmt.setString(6, loyalValue);
        updateStmt.setString(7, prestasiValue);
        updateStmt.setString(8, idGapText);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gapkonvert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gapkonvert().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton tablegap;
    private javax.swing.JButton tablekonvert;
