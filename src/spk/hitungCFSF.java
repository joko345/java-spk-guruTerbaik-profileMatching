...
public class hitungCFSF extends javax.swing.JFrame {
 private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    String oldId = null;

    protected void aktif() {
        idcf.setEnabled(true);
        disiplin.setEnabled(true);
        komitmen.setEnabled(true);
        idcf.requestFocus();
    }
 ...
 private void dataTable() {
  Object[] Baris = {"Id CFSF", "id GAP", "Id Kelas", "Nama Guru", "Disiplin", "Komitmen", "Materi", "Loyal", "Prestasi", "nilai Core", "nilai Second"};
    tabmode = new DefaultTableModel(null, Baris);
    jTable1.setModel(tabmode);
     String sql = "SELECT b.idcf, a.idGap, a.namaGuru, c.idKelas, a.nilaiDisiplin, a.nilaiKomitmen, c.totalMateri, a.nilaiLoyal, a.nilaiPrestasi, b.nilaiCore, b.nilaiSecond " +
                 "FROM cftabel b " +
                 "JOIN normaltable a ON a.idGap = b.idGap " +
                 "JOIN kelastabel c ON c.idKelas = b.idKelas";
    ...
    try {
        ...
        while (hasil.next()) {
            String idCFSF = hasil.getString("idcf");
            ...
            String[] data = {idCFSF, idGAP, idKelas, namaGuru, disiplin, komitmen, materi, loyal, prestasi, cf, sf};
            tabmode.addRow(data);
        }
  ...
  private void setWelcomeMessage(JLabel tanggal) {
    ...
    private void initComponents() {
        ...
        idcfsf = new javax.swing.JLabel();
        idcf = new javax.swing.JTextField();
        idgap = new javax.swing.JLabel();
        boxGap = new javax.swing.JComboBox<>();
        kelasTxt = new javax.swing.JLabel();
        boxKelas = new javax.swing.JComboBox<>();
        DisiplinTeks1 = new javax.swing.JLabel();
        ...
        dihitungTeks = new javax.swing.JLabel();
        boxSecond = new javax.swing.JComboBox<>();
        ...
        idcfsf.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        idcfsf.setText("Id CFSF");
        jPanel1.add(idcfsf, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 360, 140, -1));

        idcf.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(idcf, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 360, 90, -1));

        idgap.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        idgap.setText("Id Gap");
        jPanel1.add(idgap, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 400, 140, -1));

        boxGap.setFont(new java.awt.Font("Dubai", 0, 12)); // NOI18N
        boxGap.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        boxGap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boxGapActionPerformed(evt);
            }
        });
        jPanel1.add(boxGap, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 400, 90, 30));

        kelasTxt.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        kelasTxt.setText("Id Kelas");
        jPanel1.add(kelasTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 440, 140, -1));

        boxKelas.setFont(new java.awt.Font("Dubai", 0, 12)); // NOI18N
        boxKelas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        boxKelas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boxKelasActionPerformed(evt);
            }
        });
        jPanel1.add(boxKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 440, 90, 30));

        DisiplinTeks1.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        DisiplinTeks1.setText("Nama Guru");
        jPanel1.add(DisiplinTeks1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 480, 140, -1));

        namaGuru.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(namaGuru, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 480, 90, -1));

        DisiplinTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        DisiplinTeks.setText("Nilai Disiplin");
        jPanel1.add(DisiplinTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 520, 140, -1));

        disiplin.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(disiplin, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 520, 90, -1));

        komitmenTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        komitmenTeks.setText("Nilai Komitmen");
        jPanel1.add(komitmenTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 560, 140, -1));

        komitmen.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(komitmen, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 560, 90, -1));

        materiTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        materiTeks.setText("Nilai P.Materi");
        jPanel1.add(materiTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 600, 140, -1));

        materi.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(materi, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 600, 90, -1));

        dihitungTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        dihitungTeks.setText("Kriteria");
        jPanel1.add(dihitungTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 640, 140, -1));

        boxSecond.setFont(new java.awt.Font("Dubai", 0, 12)); // NOI18N
        boxSecond.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Core Factor", "Second Factor" }));
        boxSecond.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                boxSecondActionPerformed(evt);
            }
        });
        jPanel1.add(boxSecond, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 640, 90, -1));

        loyalTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        loyalTeks.setText("Nilai Loyal");
        jPanel1.add(loyalTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 680, 140, 40));

        loyal.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(loyal, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 680, 90, -1));

        prestasiTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        prestasiTeks.setText("Nilai Prestasi");
        jPanel1.add(prestasiTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 720, 140, 40));

        prestasi.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(prestasi, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 720, 90, -1));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 670, -1, -1));
        ...
        jPanel1.add(edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 670, 60, -1));
        ...
        jPanel1.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 670, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 380, 860, 270));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bg/BGCFSF.png"))); // NOI18N
 ...
 String sql = "INSERT INTO cftabel (idcf, idGap, idKelas, namaGuru, nilaiDisiplin, nilaiKomitmen, totalMateri, nilaiLoyal, nilaiPrestasi, nilaiCore, nilaiSecond) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    try { 
        PreparedStatement stat = conn.prepareStatement(sql);
        stat.setString(1, idcf.getText());
        stat.setString(2, boxGap.getSelectedItem().toString());
        stat.setString(3, boxKelas.getSelectedItem().toString());
        ...
        String selectedItem = boxSecond.getSelectedItem().toString();
        if (selectedItem.equals("Core Factor")) {
            double a = Double.parseDouble(disiplin.getText());
            double b = Double.parseDouble(komitmen.getText());
            double c = Double.parseDouble(materi.getText());
            totalCore = (a + b + c) * 0.6; // Menghitung 60% dari total nilai
            stat.setDouble(10, totalCore);

            // Tetap menggunakan nilaiSecond yang ada dalam database
            String query = "SELECT nilaiSecond FROM cftabel WHERE idcf=?";
            PreparedStatement getSecond = conn.prepareStatement(query);
            getSecond.setString(1, idcf.getText());
            ResultSet rs = getSecond.executeQuery();
            if (rs.next()) {
                totalSecond = rs.getDouble("nilaiSecond");
            }
            stat.setDouble(11, totalSecond);
        } else if (selectedItem.equals("Second Factor")) {
            double d = Double.parseDouble(loyal.getText());
            double e = Double.parseDouble(prestasi.getText());
            totalSecond = (d + e) * 0.4; // Menghitung 40% dari total nilai
            stat.setDouble(11, totalSecond);

            // Tetap menggunakan nilaiCore yang ada dalam database
            String query = "SELECT nilaiCore FROM cftabel WHERE idcf=?";
            PreparedStatement getCore = conn.prepareStatement(query);
            getCore.setString(1, idcf.getText());
            ResultSet rs = getCore.executeQuery();
            if (rs.next()) {
                totalCore = rs.getDouble("nilaiCore");
            }
            stat.setDouble(10, totalCore);
        } else {
            // Tambahkan penanganan jika selectedItem tidak cocok dengan "Core Factor" atau "Second Factor"
            JOptionPane.showMessageDialog(null, "Pilih Core Factor atau Second Factor.");
            return;
        }

        stat.executeUpdate();
        JOptionPane.showMessageDialog(null, "Data berhasil disimpan.");
        dataTable(); // Panggil kembali untuk memperbarui tampilan tabel
    } catch (SQLException e) {
        JOptionPane.showMessageDialog(null, "Error: " + e.getMessage());
    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(null, "Error: Nilai harus berupa angka.");
    }
    }//GEN-LAST:event_saveActionPerformed

    private void boxGapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxGapActionPerformed
        // TODO add your handling code here:
     String sql = "SELECT * FROM normaltable WHERE idGap = ?";
    
    try {
        PreparedStatement stat = conn.prepareStatement(sql);
        stat.setString(1, boxGap.getSelectedItem().toString());
    ...
    }//GEN-LAST:event_boxGapActionPerformed

    private void boxKelasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxKelasActionPerformed
        // TODO add your handling code here:
         String sql = "SELECT * FROM kelastabel WHERE idKelas = ?";
    
    try {
        PreparedStatement stat = conn.prepareStatement(sql);
        stat.setString(1, boxKelas.getSelectedItem().toString());
        ResultSet hasil = stat.executeQuery();
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        // TODO add your handling code here:
    try {
        String sql = "UPDATE cftabel SET idGap=?, idKelas=?, namaGuru=?, nilaiDisiplin=?, nilaiKomitmen=?, totalMateri=?, nilaiLoyal=?, nilaiPrestasi=?, nilaiCore=?, nilaiSecond=? WHERE idcf=?";
        PreparedStatement stat = conn.prepareStatement(sql);
        
        stat.setString(1, boxGap.getSelectedItem().toString());
        stat.setString(2, boxKelas.getSelectedItem().toString());
        stat.setString(3, namaGuru.getText());
        stat.setString(4, disiplin.getText());
        stat.setString(5, komitmen.getText());
        stat.setString(6, materi.getText());
        stat.setString(7, loyal.getText());
        stat.setString(8, prestasi.getText());
        ...
        stat.setString(11, idcf.getText());  
        stat.executeUpdate();
...
if (bar != -1) {
    ...
    this.oldId = a;
    idcf.setText(a);
    boxGap.setSelectedItem(b);        
    boxKelas.setSelectedItem(c);                
    namaGuru.setText(d);
    disiplin.setText(e);
    komitmen.setText(f);
    materi.setText(g);
    ...
    // Set boxSecond berdasarkan nilai Core atau Second
    double nilaiCore = Double.parseDouble(j);
    double nilaiSecond = Double.parseDouble(k);
    if (nilaiCore > 0) {
        boxSecond.setSelectedItem("Core Factor");
    } else if (nilaiSecond > 0) {
        boxSecond.setSelectedItem("Second Factor");
    }
} else {
    ...
    private void boxSecondActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxSecondActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_boxSecondActionPerformed

    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        // TODO add your handling code here:
          int ok=JOptionPane.showConfirmDialog(null, "Hapus", "Konfirmasi Dialog", JOptionPane.YES_NO_CANCEL_OPTION);
        if (ok==0){
            String sql= "delete from cftabel where idcf = '"+idcf.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hitungCFSF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hitungCFSF().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel DisiplinTeks1;
    private javax.swing.JButton back;
    private javax.swing.JLabel bg;
    private javax.swing.JComboBox<String> boxGap;
    private javax.swing.JComboBox<String> boxKelas;
    private javax.swing.JComboBox<String> boxSecond;
    ...
    private javax.swing.JLabel dihitungTeks;
    private javax.swing.JTextField disiplin;
    private javax.swing.JButton edit;
    private javax.swing.JTextField idcf;
    private javax.swing.JLabel idcfsf;
    private javax.swing.JLabel idgap;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTable jTable1;
    private javax.swing.JLabel kelasTxt;
...
public void setIdGap() {
    List<String> gapList = new ArrayList<>(); // Objek ArrayList yang akan digunakan untuk menyimpan semua idGap yang diambil dari database.
    String sql = "SELECT idGap FROM gaptabel"; // Query SQL untuk mengambil semua idGap dari tabel normaltabel
    ...
    DefaultComboBoxModel<String> cbGap = new DefaultComboBoxModel<>();
    for (String idGap : gapList) {
        cbGap.addElement(idGap);
    }

    boxGap.setModel(cbGap);
}

public void setIdKelas() {
    List<String> kelasList = new ArrayList<>(); // Objek ArrayList yang akan digunakan untuk menyimpan semua idGap yang diambil dari database.
    String sql = "SELECT idKelas FROM kelastabel"; // Query SQL untuk mengambil semua idGap dari tabel gaptabel
    ...
    try {
        ...
        while (hasil.next()) {
            String idKelas = hasil.getString("idKelas");
            kelasList.add(idKelas);
        }
    } catch (SQLException e) {
        JOptionPane.showMessageDialog(null, "Error: " + e.getMessage());
    }

    DefaultComboBoxModel<String> cbKelas = new DefaultComboBoxModel<>();
    for (String idKelas : kelasList) {
        cbKelas.addElement(idKelas);
    }

    boxKelas.setModel(cbKelas);
}
