 ...
 */
public class hitungAwal extends javax.swing.JFrame {
    ...
    private void dataTable() {
        Object[] Baris = {"Nilai Awal", "Id Guru", "Nama Guru", "disiplin", "komitmen", "Loyalitas", "Prestasi",};
        tabmode = new DefaultTableModel(null, Baris);
        jTable1.setModel(tabmode);
          String sql = "SELECT a.nilaiAwal, a.nilaiDisiplin, g.idGuru, g.namaGuru, a.nilaiKomitmen, a.nilaiLoyal, a.nilaiPrestasi " +
                 "FROM awaltabel a " +
                 "JOIN gurutabel g ON g.idGuru = a.idGuru";
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
                String idAwal = hasil.getString("nilaiAwal");
                ...
                String[] data = {idAwal, idGuru, namaGuru, disiplin, komitmen, loyal, prestasi};
                tabmode.addRow(data);
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        idNilaiAwal = new javax.swing.JTextField();
        ...
        jPanel1.add(awalTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 380, 140, -1));

        idNilaiAwal.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(idNilaiAwal, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 380, 90, -1));

        nama1.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        nama1.setText("Nama Guru");
        jPanel1.add(nama1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 460, 140, -1));

        namaGuru.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(namaGuru, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 460, 90, -1));

        guruTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        guruTeks.setText("Id Guru");
        jPanel1.add(guruTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 420, 140, -1));
        ...
        jPanel1.add(boxGuru, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 420, 90, -1));

        DisiplinTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        DisiplinTeks.setText("Nilai Disiplin");
        jPanel1.add(DisiplinTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 500, 140, -1));

        disiplin.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(disiplin, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 500, 90, -1));

        komitmenTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        komitmenTeks.setText("Nilai Komitmen");
        jPanel1.add(komitmenTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 540, 140, -1));

        komitmen.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(komitmen, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 540, 90, -1));

        loyalTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        loyalTeks.setText("Nilai Loyal");
        jPanel1.add(loyalTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 580, 140, 40));

        loyal.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(loyal, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 580, 90, -1));

        prestasiTeks.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        prestasiTeks.setText("Nilai Prestasi");
        jPanel1.add(prestasiTeks, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 620, 140, 40));

        prestasi.setFont(new java.awt.Font("Dubai", 0, 14)); // NOI18N
        jPanel1.add(prestasi, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 620, 90, -1));
        ...
        jPanel1.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 620, -1, -1));
        ...
        jPanel1.add(edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 620, 60, -1));
        ...
        jPanel1.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 620, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 380, 570, 230));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bg/kriteria.png"))); // NOI18N
    ...
    String sql = "INSERT INTO awaltabel VALUES (?,?,?,?,?,?,?)";
    try {
    PreparedStatement stat = conn.prepareStatement(sql);
    stat.setString(1, idNilaiAwal.getText());
    ...
    stat.setString(6, loyal.getText());
    stat.setString(7, prestasi.getText());
    stat.executeUpdate();
    JOptionPane.showMessageDialog(null, "Berhasil Simpan");
    kosong();
    idNilaiAwal.requestFocus();
    dataTable();    
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
     try {
        String sql = "UPDATE awaltabel SET nilaiAwal=?, idGuru=?, namaGuru=?, nilaiDisiplin=?, nilaiKomitmen=?, nilaiLoyal=?, nilaiPrestasi=? WHERE nilaiAwal=?";
        PreparedStatement stat = conn.prepareStatement(sql);
        stat.setString(1, idNilaiAwal.getText());
        stat.setString(2, boxGuru.getSelectedItem().toString());
        stat.setString(3, namaGuru.getText());         
    ...
    String nilaiAwal = tabmode.getValueAt(bar, 0).toString();
    String idGuru = tabmode.getValueAt(bar, 1).toString();
    String namaGuru1 = tabmode.getValueAt(bar, 2).toString();
    String nilaiDisiplin = tabmode.getValueAt(bar, 3).toString();
    String nilaiKomitmen = tabmode.getValueAt(bar, 4).toString();
    String nilaiLoyal = tabmode.getValueAt(bar, 5).toString();
    String nilaiPrestasi = tabmode.getValueAt(bar, 6).toString();
    
    // Menampilkan nilai-nilai di console (opsional)
    System.out.println(nilaiAwal + " " + idGuru + " " + namaGuru1 + " " + nilaiDisiplin + " " + nilaiKomitmen + " " + nilaiLoyal + " " + nilaiPrestasi);
    
    this.oldId = nilaiAwal;
    idNilaiAwal.setText(nilaiAwal);
    namaGuru.setText(namaGuru1);
    disiplin.setText(nilaiDisiplin);
    komitmen.setText(nilaiKomitmen);
    loyal.setText(nilaiLoyal);
    boxGuru.setSelectedItem(idGuru);
    prestasi.setText(nilaiPrestasi);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (ok==0){
            String sql= "delete from awaltabel where nilaiAwal = '"+idNilaiAwal.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    try {
        ...
        while (hasil.next()) {
            ...
            loyal.setText(hasil.getString("lamaMengajar"));
    ...
    private void buttonGuru3MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonGuru3MouseExited
        // TODO add your handling code here:
        buttonGuru3.setBackground(new Color(135, 104, 61));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hitungAwal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new hitungAwal().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField idNilaiAwal;
